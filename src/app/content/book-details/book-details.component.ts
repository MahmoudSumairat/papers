...
export class BookDetailsComponent implements OnInit, OnDestroy {
  ...
  ngOnInit() {
    this.title.setTitle("Books - " + this.bookName); // CHANGE THE TITLE OF THE PAGE
  ...
  readBook(book) { // ADD THE BOOK TO READ BOOKS 
    if (this.isAuth) {
      this.bookDetailsService.readThisBook(
        book,
        this.user.userID,
        this.bookName
      );
  ...
  currentlyReadingBook(book) { // ADD THE BOOK TO CURRENLTY READING BOOKS
    if (this.isAuth) {
      this.bookDetailsService.currentlyReadingThisBook(
        book,
        this.user.userID,
        this.bookName
      );
  ...
  wantToReadBook(book) { // ADD THE BOOK TO WANT TO READ BOOKS
    if (this.isAuth) {
      this.bookDetailsService.wantToReadThisBook(
        book,
        this.user.userID,
        this.bookName
      );
  ...
  undo() {
    if (this.readBooks) {
      this.bookDetailsService.undoChanges(
        this.readBooks,
        this.bookName,
        this.user.userID,
        "read-books"
